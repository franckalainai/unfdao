...
@section('content')
  ...
  <!--Page Header Start-->
  <section class="page-header" style="background-image: url(assets/images/backgrounds/donate.jpg);">
    <div class="container">
        <div class="page-header__inner">
            <h2>Merci de votre générosité</h2>
            <!--
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8">
              ...
              <h2>Envoyer votre don via Paypal</h2>
              <br>
                    <form method="POST" id="payment-form" action="{{ route('paypal') }}" class="w3-container w3-display-middle w3-card-4 w3-padding-16">
                      {{ csrf_field() }}  
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="contact-form__input-box">
                                    <input type="text" placeholder="your amount" id="amount" type="text" name="amount" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                                <button type="submit" class="thm-btn contact-form__btn">Payer avec PayPal</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-xl-4 d-flex align-items-stretch">
                <div class="contact-page__info-box">
                    <div class="contact-page__info-box-address">
                        <h3 class="contact-page__info-box-tilte" style="color: red">Envoyer votre don par chèque</h3>
                        <!--
                    ...
                    <div class="contact-page__info-box-phone">
                        <h4 class="contact-page__info-box-tilte">Numéro compte bancaire</h4>
                        <p class="contact-page__info-box-phone-number">
                            <p><b>Ecobank: </b>0000 888 0000</p> <br>
